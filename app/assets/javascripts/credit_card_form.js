...
// Set up plan change event listener #tenant_plan id in the forms fof class cc_form
// call plan change handler to that the plan is set correctly in the drop down when the page loads
